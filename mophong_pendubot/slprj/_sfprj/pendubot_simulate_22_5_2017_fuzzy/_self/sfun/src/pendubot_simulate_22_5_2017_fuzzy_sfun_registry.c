...
{
  extern unsigned int
    sf_pendubot_simulate_22_5_2017_fuzzy_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_pendubot_simulate_22_5_2017_fuzzy_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_pendubot_simulate_22_5_2017_fuzzy_autoinheritance_info(
  ...
  if (strcmp(machineName, "pendubot_simulate_22_5_2017_fuzzy") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_pendubot_simulate_22_5_2017_fuzzy_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_pendubot_simulate_22_5_2017_fuzzy_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "pendubot_simulate_22_5_2017_fuzzy") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_pendubot_simulate_22_5_2017_fuzzy_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_pendubot_simulate_22_5_2017_fuzzy_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"pendubot_simulate_22_5_2017_fuzzy")) {
    return(sf_pendubot_simulate_22_5_2017_fuzzy_method_dispatcher(simstructPtr,
...
extern void pendubot_simulate_22_5_2017_fuzzy_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    pendubot_simulate_22_5_2017_fuzzy_terminator();
    sf_debug_terminate();
  }
...
extern void pendubot_simulate_22_5_2017_fuzzy_initializer(void);
extern void pendubot_simulate_22_5_2017_fuzzy_register_exported_symbols
  (SimStruct* S);
extern void pendubot_simulate_22_5_2017_fuzzy_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  pendubot_simulate_22_5_2017_fuzzy_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      pendubot_simulate_22_5_2017_fuzzy_debug_initialize();
    }

    pendubot_simulate_22_5_2017_fuzzy_initializer();
  }
