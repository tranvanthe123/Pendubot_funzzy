...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_lay_dulieu_cua_bodieukhientruot_process_check_sum_call(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_lay_dulieu_cua_bodieukhientruot_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_lay_dulieu_cua_bodieukhientruot_autoinheritance_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "lay_dulieu_cua_bodieukhientruot") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_lay_dulieu_cua_bodieukhientruot_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_lay_dulieu_cua_bodieukhientruot_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "lay_dulieu_cua_bodieukhientruot") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_lay_dulieu_cua_bodieukhientruot_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_lay_dulieu_cua_bodieukhientruot_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"lay_dulieu_cua_bodieukhientruot")) {
    return(sf_lay_dulieu_cua_bodieukhientruot_method_dispatcher(simstructPtr,
...
extern void lay_dulieu_cua_bodieukhientruot_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    lay_dulieu_cua_bodieukhientruot_terminator();
    sf_debug_terminate();
  }
...
extern void lay_dulieu_cua_bodieukhientruot_initializer(void);
extern void lay_dulieu_cua_bodieukhientruot_register_exported_symbols(SimStruct*
  S);
extern void lay_dulieu_cua_bodieukhientruot_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  lay_dulieu_cua_bodieukhientruot_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      lay_dulieu_cua_bodieukhientruot_debug_initialize();
    }

    lay_dulieu_cua_bodieukhientruot_initializer();
  }
