...
#include "c2_pendubot_simulate_1_8_5_2017.h"
...
static void initialize_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
static void initialize_params_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
static void enable_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
static void disable_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
static void set_sim_state_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
static void sf_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
static void c2_chartstep_c2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
static void initSimStructsc2_pendubot_simulate_1_8_5_2017
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance, const mxArray
   *c2_q2_2dot, const char_T *c2_identifier);
...
static void c2_eml_scalar_eg(SFc2_pendubot_simulate_1_8_5_2017InstanceStruct
  *chartInstance);
static real_T c2_mpower(SFc2_pendubot_simulate_1_8_5_2017InstanceStruct
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance, const mxArray
   *c2_b_is_active_c2_pendubot_simulate_1_8_5_2017, const char_T *c2_identifier);
  ...
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_pendubot_simulate_1_8_5_2017 = 0U;
}
  ...
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal =
    chartInstance->c2_is_active_c2_pendubot_simulate_1_8_5_2017;
   ...
   *c2_st)
{
  ...
  *c2_q2_2dot = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_pendubot_simulate_1_8_5_2017 =
    ...
    "is_active_c2_pendubot_simulate_1_8_5_2017");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_pendubot_simulate_1_8_5_2017(chartInstance);
  ...
  (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_pendubot_simulate_1_8_5_2017(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance;
  chartInstance = (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_pendubot_simulate_1_8_5_2017_get_eml_resolved_functions_info(void)
{
   ...
   *c2_b_is_active_c2_pendubot_simulate_1_8_5_2017, const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_pendubot_simulate_1_8_5_2017), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_pendubot_simulate_1_8_5_2017);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_pendubot_simulate_1_8_5_2017_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_pendubot_simulate_1_8_5_2017_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_pendubot_simulate_1_8_5_2017(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"q1_2dot\",},{M[1],M[10],T\"q2_2dot\",},{M[8],M[0],T\"is_active_c2_pendubot_simulate_1_8_5_2017\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_pendubot_simulate_1_8_5_2017_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_pendubot_simulate_1_8_5_2017(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_pendubot_simulate_1_8_5_2017
    ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*) chartInstanceVar);
  initialize_c2_pendubot_simulate_1_8_5_2017
    ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_pendubot_simulate_1_8_5_2017(void
  *chartInstanceVar)
{
  enable_c2_pendubot_simulate_1_8_5_2017
    ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_pendubot_simulate_1_8_5_2017(void
  *chartInstanceVar)
{
  disable_c2_pendubot_simulate_1_8_5_2017
    ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_pendubot_simulate_1_8_5_2017(void
  *chartInstanceVar)
{
  sf_c2_pendubot_simulate_1_8_5_2017
    ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_pendubot_simulate_1_8_5_2017
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_pendubot_simulate_1_8_5_2017
    ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_pendubot_simulate_1_8_5_2017();/* state var info */
...
extern void sf_internal_set_sim_state_c2_pendubot_simulate_1_8_5_2017(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_pendubot_simulate_1_8_5_2017
    ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_pendubot_simulate_1_8_5_2017
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_pendubot_simulate_1_8_5_2017(S);
}

static void sf_opaque_set_sim_state_c2_pendubot_simulate_1_8_5_2017(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_pendubot_simulate_1_8_5_2017(S, st);
}

static void sf_opaque_terminate_c2_pendubot_simulate_1_8_5_2017(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_pendubot_simulate_1_8_5_2017
      ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_pendubot_simulate_1_8_5_2017
    ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_pendubot_simulate_1_8_5_2017(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_pendubot_simulate_1_8_5_2017
      ((SFc2_pendubot_simulate_1_8_5_2017InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_pendubot_simulate_1_8_5_2017(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_pendubot_simulate_1_8_5_2017(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_pendubot_simulate_1_8_5_2017(SimStruct *S)
{
  SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *chartInstance;
  chartInstance = (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct *)malloc
    (sizeof(SFc2_pendubot_simulate_1_8_5_2017InstanceStruct));
  memset(chartInstance, 0, sizeof
         (SFc2_pendubot_simulate_1_8_5_2017InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_pendubot_simulate_1_8_5_2017;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_pendubot_simulate_1_8_5_2017;
...
void c2_pendubot_simulate_1_8_5_2017_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_pendubot_simulate_1_8_5_2017(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_pendubot_simulate_1_8_5_2017(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_pendubot_simulate_1_8_5_2017(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_pendubot_simulate_1_8_5_2017_method_dispatcher.\n"
