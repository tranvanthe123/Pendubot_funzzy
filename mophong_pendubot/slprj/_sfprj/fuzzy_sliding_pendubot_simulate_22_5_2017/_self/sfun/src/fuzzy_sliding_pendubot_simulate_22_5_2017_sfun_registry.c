...
{
  extern unsigned int
    sf_fuzzy_sliding_pendubot_simulate_22_5_2017_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_fuzzy_sliding_pendubot_simulate_22_5_2017_process_check_sum_call(nlhs,
       plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_fuzzy_sliding_pendubot_simulate_22_5_2017_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "fuzzy_sliding_pendubot_simulate_22_5_2017") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_fuzzy_sliding_pendubot_simulate_22_5_2017_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_fuzzy_sliding_pendubot_simulate_22_5_2017_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"fuzzy_sliding_pendubot_simulate_22_5_2017")) {
    return(sf_fuzzy_sliding_pendubot_simulate_22_5_2017_method_dispatcher
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    fuzzy_sliding_pendubot_simulate_22_5_2017_terminator();
    sf_debug_terminate();
  }
...
extern void fuzzy_sliding_pendubot_simulate_22_5_2017_register_exported_symbols
  (SimStruct* S);
extern void fuzzy_sliding_pendubot_simulate_22_5_2017_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  fuzzy_sliding_pendubot_simulate_22_5_2017_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      fuzzy_sliding_pendubot_simulate_22_5_2017_debug_initialize();
    }

    fuzzy_sliding_pendubot_simulate_22_5_2017_initializer();
  }
