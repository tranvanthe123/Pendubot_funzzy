...
#include "c4_pendubot_simulate_with_sign.h"
...
static const char * c4_debug_family_names[30] = { "beta1", "beta2", "beta3",
  "beta4", "beta5", "g", "f1", "f2", "b1", "b2", "s1", "s2", "u_eq_1", "u_eq_2",
  "S1", "S2", "nargin", "nargout", "x1", "x2", "x3", "x4", "a1", "a2", "c1",
  "c2", "k2", "nuy2", "sign_S2", "u" };

/* Function Declarations */
static void initialize_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void initialize_params_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void enable_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void disable_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void set_sim_state_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance, const mxArray *
   c4_st);
static void finalize_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void sf_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void c4_chartstep_c4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void initSimStructsc4_pendubot_simulate_with_sign
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_pendubot_simulate_with_signInstanceStruct
  *chartInstance, const mxArray *c4_u, const char_T *c4_identifier);
...
static void c4_eml_scalar_eg(SFc4_pendubot_simulate_with_signInstanceStruct
  *chartInstance);
static real_T c4_mpower(SFc4_pendubot_simulate_with_signInstanceStruct
...
static uint8_T c4_d_emlrt_marshallIn
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance, const mxArray *
   c4_b_is_active_c4_pendubot_simulate_with_sign, const char_T *c4_identifier);
static uint8_T c4_e_emlrt_marshallIn
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance, const mxArray *
   c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_pendubot_simulate_with_signInstanceStruct
  *chartInstance);
  ...
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_pendubot_simulate_with_sign = 0U;
}
  ...
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance)
{
  ...
  c4_b_hoistedGlobal =
    chartInstance->c4_is_active_c4_pendubot_simulate_with_sign;
   ...
   c4_st)
{
  ...
  *c4_b_u = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 0)),
  ...
  chartInstance->c4_is_active_c4_pendubot_simulate_with_sign =
    ...
    "is_active_c4_pendubot_simulate_with_sign");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_pendubot_simulate_with_sign(chartInstance);
  ...
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance)
{
  ...
  real_T *c4_nuy2;
  real_T *c4_sign_S2;
  c4_sign_S2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  ...
  _SFD_DATA_RANGE_CHECK(*c4_sign_S2, 11U);
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_pendubot_simulate_with_sign(chartInstance);
  ...
  (SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance)
{
  ...
  real_T *c4_b_x1;
  real_T *c4_b_u;
  c4_b_sign_S2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  ...
  c4_k_hoistedGlobal = *c4_b_sign_S2;
  ...
  c4_sign_S2 = c4_k_hoistedGlobal;
  sf_debug_symbol_scope_push_eml(0U, 30U, 30U, c4_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml(&c4_sign_S2, 28U, c4_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c4_u, 29U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance;
  chartInstance = (SFc4_pendubot_simulate_with_signInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c4_pendubot_simulate_with_sign_get_eml_resolved_functions_info
  (void)
{
   ...
   c4_b_is_active_c4_pendubot_simulate_with_sign, const char_T *c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_pendubot_simulate_with_sign), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_pendubot_simulate_with_sign);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_pendubot_simulate_with_sign_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1993106701U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1021645123U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3404173286U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3701270207U);
}

mxArray *sf_c4_pendubot_simulate_with_sign_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("wOY1GyqQnQKywZRNKvviDB");
...
static const mxArray *sf_get_sim_state_info_c4_pendubot_simulate_with_sign(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"u\",},{M[8],M[0],T\"is_active_c4_pendubot_simulate_with_sign\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_pendubot_simulate_with_sign_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(11,1,1,0,"sign_S2");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,959);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(11U, c4_sign_S2);
        }
      }
    } else {
...
{
  return "uNDjBbiGJn2esj3YsrrPmG";
}

static void sf_opaque_initialize_c4_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_pendubot_simulate_with_signInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_pendubot_simulate_with_sign
    ((SFc4_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
  initialize_c4_pendubot_simulate_with_sign
    ((SFc4_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  enable_c4_pendubot_simulate_with_sign
    ((SFc4_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  disable_c4_pendubot_simulate_with_sign
    ((SFc4_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  sf_c4_pendubot_simulate_with_sign
    ((SFc4_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_pendubot_simulate_with_sign
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_pendubot_simulate_with_sign
    ((SFc4_pendubot_simulate_with_signInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_pendubot_simulate_with_sign();/* state var info */
...
extern void sf_internal_set_sim_state_c4_pendubot_simulate_with_sign(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_pendubot_simulate_with_sign
    ((SFc4_pendubot_simulate_with_signInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_pendubot_simulate_with_sign
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c4_pendubot_simulate_with_sign(S);
}

static void sf_opaque_set_sim_state_c4_pendubot_simulate_with_sign(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c4_pendubot_simulate_with_sign(S, st);
}

static void sf_opaque_terminate_c4_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_pendubot_simulate_with_signInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_pendubot_simulate_with_sign
      ((SFc4_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc4_pendubot_simulate_with_sign
    ((SFc4_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_pendubot_simulate_with_sign(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c4_pendubot_simulate_with_sign
      ((SFc4_pendubot_simulate_with_signInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c4_pendubot_simulate_with_sign(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2865178327U));
  ssSetChecksum1(S,(775202164U));
  ssSetChecksum2(S,(803805942U));
  ssSetChecksum3(S,(3699140724U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c4_pendubot_simulate_with_sign(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_pendubot_simulate_with_sign(SimStruct *S)
{
  SFc4_pendubot_simulate_with_signInstanceStruct *chartInstance;
  chartInstance = (SFc4_pendubot_simulate_with_signInstanceStruct *)malloc
    (sizeof(SFc4_pendubot_simulate_with_signInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_pendubot_simulate_with_signInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_pendubot_simulate_with_sign;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_pendubot_simulate_with_sign;
...
void c4_pendubot_simulate_with_sign_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_pendubot_simulate_with_sign(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_pendubot_simulate_with_sign(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_pendubot_simulate_with_sign(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_pendubot_simulate_with_sign_method_dispatcher.\n"
