...
#include "c2_pendubot_simulate_with_sign.h"
...
static void initialize_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void initialize_params_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void enable_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void disable_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void set_sim_state_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance, const mxArray *
   c2_st);
static void finalize_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void sf_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void c2_chartstep_c2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void initSimStructsc2_pendubot_simulate_with_sign
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_pendubot_simulate_with_signInstanceStruct
  *chartInstance, const mxArray *c2_q2_2dot, const char_T *c2_identifier);
...
static void c2_eml_scalar_eg(SFc2_pendubot_simulate_with_signInstanceStruct
  *chartInstance);
static real_T c2_mpower(SFc2_pendubot_simulate_with_signInstanceStruct
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance, const mxArray *
   c2_b_is_active_c2_pendubot_simulate_with_sign, const char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance, const mxArray *
   c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_pendubot_simulate_with_signInstanceStruct
  *chartInstance);
  ...
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_pendubot_simulate_with_sign = 0U;
}
  ...
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal =
    chartInstance->c2_is_active_c2_pendubot_simulate_with_sign;
   ...
   c2_st)
{
  ...
  *c2_q2_2dot = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c2_is_active_c2_pendubot_simulate_with_sign =
    ...
    "is_active_c2_pendubot_simulate_with_sign");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_pendubot_simulate_with_sign(chartInstance);
  ...
  (SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_pendubot_simulate_with_sign(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance;
  chartInstance = (SFc2_pendubot_simulate_with_signInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_pendubot_simulate_with_sign_get_eml_resolved_functions_info
  (void)
{
   ...
   c2_b_is_active_c2_pendubot_simulate_with_sign, const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_pendubot_simulate_with_sign), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_pendubot_simulate_with_sign);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_pendubot_simulate_with_sign_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_pendubot_simulate_with_sign_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_pendubot_simulate_with_sign(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"q1_2dot\",},{M[1],M[10],T\"q2_2dot\",},{M[8],M[0],T\"is_active_c2_pendubot_simulate_with_sign\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_pendubot_simulate_with_sign_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_pendubot_simulate_with_signInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_pendubot_simulate_with_sign
    ((SFc2_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
  initialize_c2_pendubot_simulate_with_sign
    ((SFc2_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  enable_c2_pendubot_simulate_with_sign
    ((SFc2_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  disable_c2_pendubot_simulate_with_sign
    ((SFc2_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  sf_c2_pendubot_simulate_with_sign
    ((SFc2_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_pendubot_simulate_with_sign
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_pendubot_simulate_with_sign
    ((SFc2_pendubot_simulate_with_signInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_pendubot_simulate_with_sign();/* state var info */
...
extern void sf_internal_set_sim_state_c2_pendubot_simulate_with_sign(SimStruct*
  S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_pendubot_simulate_with_sign
    ((SFc2_pendubot_simulate_with_signInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_pendubot_simulate_with_sign
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_pendubot_simulate_with_sign(S);
}

static void sf_opaque_set_sim_state_c2_pendubot_simulate_with_sign(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_pendubot_simulate_with_sign(S, st);
}

static void sf_opaque_terminate_c2_pendubot_simulate_with_sign(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_pendubot_simulate_with_signInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_pendubot_simulate_with_sign
      ((SFc2_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_pendubot_simulate_with_sign
    ((SFc2_pendubot_simulate_with_signInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_pendubot_simulate_with_sign(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_pendubot_simulate_with_sign
      ((SFc2_pendubot_simulate_with_signInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_pendubot_simulate_with_sign(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_pendubot_simulate_with_sign(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_pendubot_simulate_with_sign(SimStruct *S)
{
  SFc2_pendubot_simulate_with_signInstanceStruct *chartInstance;
  chartInstance = (SFc2_pendubot_simulate_with_signInstanceStruct *)malloc
    (sizeof(SFc2_pendubot_simulate_with_signInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_pendubot_simulate_with_signInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_pendubot_simulate_with_sign;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_pendubot_simulate_with_sign;
...
void c2_pendubot_simulate_with_sign_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_pendubot_simulate_with_sign(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_pendubot_simulate_with_sign(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_pendubot_simulate_with_sign(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_pendubot_simulate_with_sign_method_dispatcher.\n"
