...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_pendubot_simulate_with_sign_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_pendubot_simulate_with_sign_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_pendubot_simulate_with_sign_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "pendubot_simulate_with_sign") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_pendubot_simulate_with_sign_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_pendubot_simulate_with_sign_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "pendubot_simulate_with_sign") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_pendubot_simulate_with_sign_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_pendubot_simulate_with_sign_method_dispatcher(SimStruct
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"pendubot_simulate_with_sign")) {
    return(sf_pendubot_simulate_with_sign_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    pendubot_simulate_with_sign_terminator();
    sf_debug_terminate();
  }
...
extern void pendubot_simulate_with_sign_register_exported_symbols(SimStruct* S);
extern void pendubot_simulate_with_sign_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  pendubot_simulate_with_sign_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      pendubot_simulate_with_sign_debug_initialize();
    }

    pendubot_simulate_with_sign_initializer();
  }
