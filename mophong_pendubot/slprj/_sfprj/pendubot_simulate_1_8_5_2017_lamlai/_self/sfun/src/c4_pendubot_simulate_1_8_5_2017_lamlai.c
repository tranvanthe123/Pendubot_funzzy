...
#include "c4_pendubot_simulate_1_8_5_2017_lamlai.h"
...
static void initialize_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static void initialize_params_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static void enable_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static void disable_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static void c4_update_debugger_state_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static void set_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance, const
   mxArray *c4_st);
static void finalize_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static void sf_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static void c4_chartstep_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static void initSimStructsc4_pendubot_simulate_1_8_5_2017_lamlai
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
...
static void c4_eml_scalar_eg
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance);
static real_T c4_mpower(SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct
...
static uint8_T c4_d_emlrt_marshallIn
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance, const
   mxArray *c4_b_is_active_c4_pendubot_simulate_1_8_5_2017_lamlai, const char_T *
   c4_identifier);
  ...
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_pendubot_simulate_1_8_5_2017_lamlai = 0U;
}
  ...
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance)
{
  ...
  c4_b_hoistedGlobal =
    chartInstance->c4_is_active_c4_pendubot_simulate_1_8_5_2017_lamlai;
   ...
   mxArray *c4_st)
{
  ...
  *c4_b_u = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 0)),
  ...
  chartInstance->c4_is_active_c4_pendubot_simulate_1_8_5_2017_lamlai =
    ...
    "is_active_c4_pendubot_simulate_1_8_5_2017_lamlai");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_pendubot_simulate_1_8_5_2017_lamlai(chartInstance);
  ...
  (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_pendubot_simulate_1_8_5_2017_lamlai(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance;
  chartInstance = (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c4_pendubot_simulate_1_8_5_2017_lamlai_get_eml_resolved_functions_info
  (void)
{
   ...
   c4_identifier)
{
  ...
  c4_y = c4_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_pendubot_simulate_1_8_5_2017_lamlai), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_pendubot_simulate_1_8_5_2017_lamlai);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_pendubot_simulate_1_8_5_2017_lamlai_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_pendubot_simulate_1_8_5_2017_lamlai_get_autoinheritance_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c4_pendubot_simulate_1_8_5_2017_lamlai(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[4],T\"u\",},{M[8],M[0],T\"is_active_c4_pendubot_simulate_1_8_5_2017_lamlai\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_pendubot_simulate_1_8_5_2017_lamlai_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c4_pendubot_simulate_1_8_5_2017_lamlai(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c4_pendubot_simulate_1_8_5_2017_lamlai
    ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*) chartInstanceVar);
  initialize_c4_pendubot_simulate_1_8_5_2017_lamlai
    ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c4_pendubot_simulate_1_8_5_2017_lamlai(void
  *chartInstanceVar)
{
  enable_c4_pendubot_simulate_1_8_5_2017_lamlai
    ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c4_pendubot_simulate_1_8_5_2017_lamlai(void
  *chartInstanceVar)
{
  disable_c4_pendubot_simulate_1_8_5_2017_lamlai
    ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c4_pendubot_simulate_1_8_5_2017_lamlai(void
  *chartInstanceVar)
{
  sf_c4_pendubot_simulate_1_8_5_2017_lamlai
    ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai
    ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c4_pendubot_simulate_1_8_5_2017_lamlai();/* state var info */
...
extern void sf_internal_set_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai
    ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai(S);
}

static void sf_opaque_set_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai(S, st);
}

static void sf_opaque_terminate_c4_pendubot_simulate_1_8_5_2017_lamlai(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_pendubot_simulate_1_8_5_2017_lamlai
      ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc4_pendubot_simulate_1_8_5_2017_lamlai
    ((SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_pendubot_simulate_1_8_5_2017_lamlai
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_pendubot_simulate_1_8_5_2017_lamlai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c4_pendubot_simulate_1_8_5_2017_lamlai(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_pendubot_simulate_1_8_5_2017_lamlai(SimStruct *S)
{
  SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *chartInstance;
  chartInstance = (SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct *)
    malloc(sizeof(SFc4_pendubot_simulate_1_8_5_2017_lamlaiInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c4_pendubot_simulate_1_8_5_2017_lamlai;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_pendubot_simulate_1_8_5_2017_lamlai;
...
void c4_pendubot_simulate_1_8_5_2017_lamlai_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_pendubot_simulate_1_8_5_2017_lamlai(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_pendubot_simulate_1_8_5_2017_lamlai(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_pendubot_simulate_1_8_5_2017_lamlai(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_pendubot_simulate_1_8_5_2017_lamlai_method_dispatcher.\n"
